...
![ProRL-Agent-Server 进程放置（论文 Fig.）](wiki/agentic-rl/prorl-agent-figs/system-architecture.png)
...
![吞吐 vs 节点数（论文 Fig.）](wiki/agentic-rl/prorl-agent-figs/throughput-vs-nodes.png)
...
>
> ![STEM / Math / Code 三个 agent 的训练曲线（论文 Fig. 4）](wiki/agentic-rl/prorl-agent-figs/training-curves.png)
>
