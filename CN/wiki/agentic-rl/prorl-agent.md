...
![ProRL-Agent-Server 进程放置（论文 Fig.）](../../sources/papers/prorl-agent/figs/system-architecture.png)
...
![吞吐 vs 节点数（论文 Fig.）](../../sources/papers/prorl-agent/figs/throughput-vs-nodes.png)
