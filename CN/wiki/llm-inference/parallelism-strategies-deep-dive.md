...
> - **TensorRT-LLM**：`context_parallel_size` + `cp_config` 作为一等公民 API 暴露（[文档](https://nvidia.github.io/TensorRT-LLM/features/parallel-strategy.html)）。公开文档对 kernel / decode 行为讲得很薄，API 表面记了，内部实现没披露。
>
