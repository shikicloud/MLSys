...
const defaultOptions: ReaderModeOptions = { side: "left" }

export default ((userOpts?: ReaderModeOptions) => {
  ...
  const ReaderMode: QuartzComponent = ({ displayClass, cfg }: QuartzComponentProps) => {
    return (
      <button
        class={classNames(displayClass, "readermode", `readermode-${side}`)}
        data-side={side}
  ...
  return ReaderMode
}) satisfies QuartzComponentConstructor<ReaderModeOptions>
